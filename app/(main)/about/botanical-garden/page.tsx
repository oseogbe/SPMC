        ...
        <div className="pt-[84px] lg:pt-18">
            <div className="relative w-full h-24 lg:h-32">
                <div className="absolute inset-0 flex justify-center items-center bg-[url(/img/palm-leafs.jpg)] bg-cover bg-bottom bg-no-repeat">
                    ...
                    <h3 className={rufina.className + " text-xl lg:text-5xl text-white text-center z-10"}>About Sarius Palmetum Botanical Garden</h3>
                </div>
            </div>
            <div className="w-full max-w-7xl mx-auto">
                <div className="px-5 lg:px-10 text-sm lg:text-2xl lg:leading-9 text-justify">
                    ...
                    <div className="space-y-4 lg:space-y-8">
                        <p>
                            The Sarius Palmetum Botanical Garden is situated in a Maitama neighborhood. But it&apos;s not just a garden of plants. There is a big ambition to transform it into a resort in addition to being a botanical park. There will soon be lodging available for those who want to spend the night and fully enjoy the experience.
                        </p>
                        <p>
                            Our founder, Mrs. Murtala Muhammed who was the wife to previous head of state, late General Murtala Muhammed, bought the strategically positioned 21 hectare land mass with a plan years ago. Because of her trips to places like Hawaii, Singapore, and Mauritius, where she gathered many of the species seen in the garden, Mrs. Muhammed developed a love for plants.
                        </p>
                        <p>
                            There are now over 1,000 different plant species, including approximately 450 palm species, in addition to those popular in Nigeria, such as the oil and coconut palm, and others like Bismarckia, golden, and royal palm. Our founder, Mrs. Murtala Muhammed has created other such places like the Murtala Muhammed Memorial Botanical Garden in Lagos, and was also part of the team that did the primary landscape planning for Obudu Cattle Ranch.
                        </p>
                        <p>
                            Sarius Palmetum also has an intriguing topography, with green hills on its outskirts, many rock formations, and a river that traverses the length of the garden. And there is a horticultural side to our operations, such as planting trees to prevent desertification in the north, because planting is neglected in the country except of those that yield crops. We are now collaborating with Aurecon South Africa, who completed a rigorous and comprehensive site assessment study and master plan to raise awareness and attention for horticulture in Nigeria while also generating funds for the garden&apos;s care and improvement.
                        </p>
                        <p>
