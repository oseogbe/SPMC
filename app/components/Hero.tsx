                ...
                <div className="max-w-7xl mx-auto p-4 lg:p-0">
                    <div className="text-center">
                        ...
                        <div className="mt-8 flex items-center justify-center space-x-4">
                            ...
                            <button className="bg-transparent text-[#E3D101] border border-[#E3D101] inner-border text-md lg:text-2xl font-semibold px-8 py-4 lg:px-12 lg:py-5 rounded lg:rounded-lg z-10" onClick={() => router.push('/contact-us')}>Contact Us</button>
                        </div>
                    </div>
                </div>
            </div>
