            ...
            <div className="absolute inset-0 bg-[url(/img/palm-forest.jpg)] bg-cover bg-top bg-no-repeat flex items-center selection:bg-transparent">
                <div className="max-w-7xl mx-auto p-4 lg:p-0">
                    <div className="text-center">
                        ...
                        <div className="mt-8 flex items-center justify-center space-x-4">
                            <button className="bg-primary text-white text-md lg:text-2xl font-semibold px-8 py-4 lg:px-12 lg:py-5 rounded lg:rounded-lg" onClick={() => router.push('/palm-species')}>Explore Now</button>
                            <button className="bg-transparent text-primary border border-primary inner-border text-md lg:text-2xl font-semibold px-8 py-4 lg:px-12 lg:py-5 rounded lg:rounded-lg" onClick={() => router.push('/contact-us')}>Contact Us</button>
                        </div>
                    </div>
                </div>
            </div>
