        ...
        <div className="w-full max-w-7xl mx-auto pt-16">
            ...
            <div className="relative px-10 py-12 bg-[#F6FDFD]">
                ...
                <div className="grid grid-cols-3 gap-8 px-10 lg:mt-16">
                    <a className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition" href="#">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            <h3 className="text-lg font-bold text-secondary-light dark:text-white">
                                Sabal palmetto
                            </h3>
                ...
                <div className="mt-12 flex items-center justify-center">
                    <button className="bg-secondary-light text-white text-lg lg:text-xl font-semibold py-2 lg:py-3 min-w-[300px] w-[30%] rounded lg:rounded-lg">See all <FaArrowRight className="inline-flex h-5 w-5" /></button>
                </div>
            </div>
        </div>
    )
