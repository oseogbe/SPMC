    ...
    return (
        <div className="w-full max-w-7xl mx-auto pt-8 lg:pt-16">
            ...
            <div className="mt-6 lg:mt-12 text-center">
                <h3 className={rufina.className + " text-secondary-light text-3xl lg:text-5xl font-bold"}>About Us</h3>
            </div>
            <div className="flex flex-col-reverse lg:flex-row items-center px-5 lg:px-0 lg:mt-16">
                ...
                <div className="mt-5 lg:flex-1 lg:mt-0">
                    <h4 className={rufina.className + " font-bold text-center text-xl lg:text-4xl lg:text-left lg:pl-11 text-secondary-light leading-10"}>Meet Our Founder</h4>
                    <div className="flex">
            ...
            <div className="flex flex-col mt-6 lg:mt-16">
                <div className="relative lg:flex lg:items-center px-5 lg:px-0">
                    <div className="lg:flex-1">
                        <h4 className={rufina.className + " font-bold text-center text-xl lg:text-4xl lg:text-left lg:pl-11 text-secondary-light leading-10"}>What We Are</h4>
