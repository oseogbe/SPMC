        ...
        <div className="w-full max-w-7xl mx-auto pt-8 lg:pt-16">
            ...
            <div className="relative px-5 lg:px-10 py-6 lg:py-12">
                <div className="text-center">
                    <h3 className={rufina.className + " text-secondary-light text-3xl lg:text-5xl font-bold"}>Our Team</h3>
                </div>
                    ...
                    {teamMembers.map((member, i) => (
                        <a key={i} className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition" href="#">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                <h5 className="text-xs lg:text-lg font-bold text-secondary-light">
                                    {member.role}
                                </h5>
                                <h4 className="mt-2 text-sm lg:text-2xl font-bold text-secondary-dark">
                                    {member.name}
                                </h4>
